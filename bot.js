...
const devs = ['532325977921945603'];
const db = require('quick.db');
const premium = ['532325977921945603']
...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`https://www.youtube.com/channel/UCIO0mWCFc26LCrjwJU_S4mA?view_as=subscriber`);
    }, ms);
...
client.channels.get("532325977921945603").sendEmbed(embed)
});
